...
const allCustomers: Customer[] = [
  { id: "C001", name: "Nadia Rahman", email: "nadia@example.com", phone: "+880-1712-345678", totalOrders: 5, totalSpent: "$389.95", joined: "Dec 2024" },
  { id: "C002", name: "Ahmed Hassan", email: "ahmed@example.com", phone: "+880-1812-654321", totalOrders: 3, totalSpent: "$199.99", joined: "Nov 2024" },
  { id: "C003", name: "Sarah Johnson", email: "sarah@example.com", phone: "+1-555-0123", totalOrders: 7, totalSpent: "$649.99", joined: "Oct 2024" },
  { id: "C004", name: "Maya Patel", email: "maya@example.com", phone: "+91-9876-543210", totalOrders: 2, totalSpent: "$89.98", joined: "Sep 2024" },
  { id: "C005", name: "Liam Smith", email: "liam@example.com", phone: "+44-7911-123456", totalOrders: 4, totalSpent: "$299.99", joined: "Aug 2024" },
  { id: "C006", name: "Ayesha Khan", email: "ayesha@example.com", phone: "+880-1712-111111", totalOrders: 6, totalSpent: "$779.94", joined: "Jul 2024" },
];
        ...
        <main className="flex-1">
          ...
          <div className="p-8">
            <div className="mb-6">
              ...
              <p className="text-sm text-slate-600 mt-1">View and manage all your customers</p>
            </div>

            <div className="bg-white rounded-lg shadow border border-slate-200">
              <div className="p-6 border-b border-slate-200 flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-medium">All Customers ({allCustomers.length})</h2>
                </div>
                <input
              ...
              <table className="w-full text-sm">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    <th className="p-3 text-left text-slate-600">Phone</th>
                    <th className="p-3 text-left text-slate-600">Orders</th>
                ...
                <tbody>
                  {allCustomers.map((customer) => (
                    <tr key={customer.id} className="border-b border-slate-200 hover:bg-slate-50">
                      ...
                      <td className="p-3 font-medium">{customer.totalSpent}</td>
                      <td className="p-3 text-slate-500 text-xs">{customer.joined}</td>
